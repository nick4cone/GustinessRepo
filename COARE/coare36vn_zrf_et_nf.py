...
def coare36vn_zrf_et_nf(u, zu , t, zt, rh, zq, P, ts, sw_dn, lw_dn, lat, lon,jd, zi,rain, Ss, cp=None, sigH=None, zrf_u=10.0, zrf_t=10.0, zrf_q=10.0):   
#**************************************************************************
# VERSION INFO:
...
def albedo_vector(sw_dn = None,jd = None,lon = None,lat = None,eorw = None): 
    ...
    psi = (np.multiply(np.arcsin(sinpsi),180) / np.pi) # Nick added .to_numpy()
    solarmax = (np.multiply(SC,sinpsi) / gamma2) # Nick added .to_numpy()
